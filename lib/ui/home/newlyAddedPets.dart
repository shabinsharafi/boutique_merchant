...
//
// class NewlyAddedPetsWidget extends StatelessWidget {
//   NewlyAddedPetsWidget(required this.value);
//
...
//     }
//
//     return value.isNewlyAddedLoading
//         ? Shimmer.fromColors(
...
//             children: [
//               _categoryheader(
//                   heading: 'Newly Added', description: "Find newly added pets"),
//               SizedBox(
//                 height: 10,
//               ),
//               Container(
...
//                   shrinkWrap: true,
//                   scrollDirection: Axis.horizontal,
//                   itemCount: value.newlyAddedResponse.data.length,
//                   itemBuilder: (context, index) {
//                     return PetsCard2(pet: value.newlyAddedResponse.data[index],onTap: (){
